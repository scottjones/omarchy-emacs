;;; omarchy-dark-theme.el --- Omarchy dark theme -*- lexical-binding: t -*-

(deftheme omarchy-dark "Omarchy dark theme synced from system colors.")
...
(custom-theme-set-faces
 ...
 `(highlight ((t (:background ,omarchy-color-bright-black))))
 ...
 `(mode-line-inactive ((t (:foreground ,omarchy-color-bright-black :background ,omarchy-color-black :box nil))))
 ...
 `(completions-first-difference ((t (:foreground ,omarchy-color-bright-white :weight bold))))
...
(provide-theme 'omarchy-dark)
;;; omarchy-dark-theme.el ends here
